    ...
    <xsl:template match="mods:mods">
        ...
        <xsl:for-each
            ...
            <field>
                <xsl:attribute name="name">
                    <xsl:value-of
                        select="concat($prefix, 'location_holdingSimple_', local-name(), $suffix)"/>
                </xsl:attribute>
                <xsl:value-of select="text()"/>
            </field>
        </xsl:for-each>
        ...
        <xsl:for-each select="mods:originInfo/mods:place/mods:placeTerm[normalize-space(text())]">
            <field>
                <xsl:attribute name="name">
                    <xsl:value-of
                        select="concat($prefix, 'originInfo_place_', local-name(), $suffix)"/>
                </xsl:attribute>
                <xsl:value-of select="text()"/>
            </field>
        </xsl:for-each>
        ...
        <xsl:for-each
            select="(mods:subject/mods:name/mods:namePart[@type][normalize-space(text())])">
            <field>
                <xsl:attribute name="name">
                    <xsl:value-of
        ...
        <xsl:for-each
            select="(mods:subject/mods:name/mods:role/mods:roleTerm[normalize-space(text())])">
            <field>
                <xsl:attribute name="name">
                    <xsl:value-of
        ...
        <xsl:for-each select="(mods:subject/mods:temporal[normalize-space(text())])">
            <field>
                <xsl:attribute name="name">
                    <xsl:value-of
                        select="concat($prefix, 'subject_authority_', translate(../@authority, ' ', '_'), local-name(), '_point_', translate(@point, ' ', '_'), $suffix)"
                    />
                </xsl:attribute>
                <xsl:value-of select="text()"/>
            </field>
