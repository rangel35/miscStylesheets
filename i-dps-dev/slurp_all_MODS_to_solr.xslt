...
<xsl:stylesheet version="1.0" xmlns:java="http://xml.apache.org/xalan/java"
  ...
  <xsl:include
    href="/usr/local/fedora/tomcat/webapps/fedoragsearch/WEB-INF/classes/fgsconfigFinal/index/FgsIndex/islandora_transforms/manuscript_finding_aid.xslt"/>
  ...
  <xsl:template match="foxml:datastream[@ID='MODS']/foxml:datastreamVersion[last()]"
    ...
    <xsl:param name="suffix">mt</xsl:param>
