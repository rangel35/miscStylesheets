        ...
        <work>
            ...
            <item>
                ...
                <dublin_core>
                    ...
                    <xsl:value-of
                        select="concat('http://www.lib.utexas.edu/taro/', $repository, '/', $file, '.xml')"/>
                    <xsl:text disable-output-escaping="yes">&#60;/dcvalue&#62;</xsl:text>
                    <xsl:text>&#10;</xsl:text>
            ...
            <item>
                ...
                <dublin_core>
                    ...
                    <xsl:text disable-output-escaping="yes">&#60;dcvalue element="identifier" qualifier="urn"&#62;</xsl:text>
                    <xsl:value-of select="concat($repo, '.', $acronym, '-', $file, '.html')"/>
                    <xsl:text disable-output-escaping="yes">&#60;/dcvalue&#62;</xsl:text>
                    <xsl:text>&#10;</xsl:text>

                    <xsl:text disable-output-escaping="yes">&#60;dcvalue element="identifier" qualifier="url"&#62;</xsl:text>
                    <xsl:value-of
                        select="concat('http://www.lib.utexas.edu/taro/', $repository, '/', $file, '/', $acronym, '-', $file, '.html')"/>
                    <xsl:text disable-output-escaping="yes">&#60;/dcvalue&#62;</xsl:text>
                    <xsl:text>&#10;</xsl:text>
            ...
            <item>
                ...
                <dublin_core>
                    ...
                    <xsl:text disable-output-escaping="yes">&#60;dcvalue element="identifier" qualifier="urn"&#62;</xsl:text>
                    <xsl:value-of select="concat($repo, '.', $file, '-P.html')"/>
                    <xsl:text disable-output-escaping="yes">&#60;/dcvalue&#62;</xsl:text>
                    <xsl:text>&#10;</xsl:text>

                    <xsl:text disable-output-escaping="yes">&#60;dcvalue element="identifier" qualifier="url"&#62;</xsl:text>
                    <xsl:value-of
                        select="concat('http://www.lib.utexas.edu/taro/', $repository, '/', $file, '/', $file, '-P.html')"/>
                    <xsl:text disable-output-escaping="yes">&#60;/dcvalue&#62;</xsl:text>
                    <xsl:text>&#10;</xsl:text>
                ...
                <item>
                    ...
                    <dublin_core>
                        ...
                        <xsl:choose>
                            ...
                            <xsl:when
                                test="contains(@href, '.mp1') or contains(@href, '.mp2') or contains(@href, '.mp3')">
                                <xsl:text>audio/mpeg</xsl:text>
                            </xsl:when>
                            <xsl:when
                                test="contains(@href, '.ram') or contains(@href, '.rm') or contains(@href, '.ra')">
                            ...
                            <xsl:when
                                test="contains(@href, '.jpeg') or contains(@href, '.jpe') or contains(@href, '.jpg')">
