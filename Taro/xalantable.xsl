...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:redirect="http://xml.apache.org/xalan/redirect" extension-element-prefixes="redirect">
    ...
    <xsl:template name="toggle">
        <div class="access-aid">
            <a href=" 00067-P.html" target="_top">Print Version</a> | <a href="http://www.lib.utexas.edu/taro/utsa/00067.xml" target="_top">Raw XML File (13k)</a>
        </div>
    </xsl:template>

 <xsl:template name="endnav">
 </xsl:template>
-->
            ...
            <head>
                ...
                <xsl:element name="meta">
                    ...
                    <xsl:attribute name="content">
                        <xsl:value-of
                            select="normalize-space(ead/eadheader/filedesc/titlestmt/titleproper)"/>
                        <xsl:text> </xsl:text>
                        <xsl:value-of
                            select="normalize-space(ead/eadheader/filedesc/titlestmt/subtitle)"/>
                    </xsl:attribute>
                </xsl:element>
                <xsl:if test="ead/archdesc/did/abstract[string-length(text()|*)!=0]">
                    <xsl:element name="meta">
                ...
                <xsl:element name="meta">
                    ...
                    <xsl:attribute name="content">
                        <xsl:for-each
                            select="ead/archdesc/did/origination/persname | ead/archdesc/did/origination/corpname | ead/archdesc//controlaccess//persname | ead/archdesc//controlaccess//corpname[@encodinganalog='700'] | ead/archdesc//controlaccess//corpname[@encodinganalog='710'] | ead/archdesc//controlaccess//famname | ead/archdesc//controlaccess//name">
                ...
                <xsl:element name="meta">
                    ...
                    <xsl:attribute name="content">
                        <xsl:for-each
                            select="ead/archdesc/did/origination/persname | ead/archdesc/did/origination/corpname | ead/archdesc/did/origination | ead/archdesc//controlaccess//persname | ead/archdesc//controlaccess//corpname[@encodinganalog='700'] | ead/archdesc//controlaccess//corpname[@encodinganalog='710'] | ead/archdesc//controlaccess//famname | ead/archdesc//controlaccess//name">
                            <xsl:value-of select="normalize-space(.)"/>
                            <xsl:text>  </xsl:text>
                        </xsl:for-each>
                    </xsl:attribute>
                ...
                <xsl:element name="meta">
                    <xsl:choose>
                        ...
                        <xsl:when test="contains($repo, 'utep')">
                            <xsl:attribute name="name">DC.Publisher</xsl:attribute>
                            <xsl:attribute name="content">University of Texas El Paso Library</xsl:attribute>
                        </xsl:when>
                ...
                <xsl:for-each
                    select="ead/archdesc//controlaccess//persname | ead/archdesc//controlaccess//corpname">
                    <xsl:choose>
                ...
                <xsl:if test="ead/archdesc//controlaccess//genreform[string-length(text()|*)!=0]">
                    <xsl:element name="meta">
                ...
                <xsl:if test="ead/archdesc//controlaccess//geogname[string-length(text()|*)!=0]">
                    <xsl:element name="meta">
    ...
    <xsl:template name="toc">
        ...
        <xsl:if
            test="ead/archdesc//userestrict[string-length(text()|*)!=0] | ead/archdesc//accessrestrict[string-length(text()|*)!=0]">
            <p class="toc-lev1">
                <strong>
                    <a href="#restrictlink">
        ...
        <xsl:if
            test="ead/archdesc//acqinfo[string-length(text()|*)!=0] | ead/archdesc//processinfo[string-length(text()|*)!=0] | ead/archdesc//prefercite[string-length(text()|*)!=0] | ead/archdesc//custodialhist[string-length(text()|*)!=0] | ead/archdesc//appraisal | ead/archdesc//altformavailable | ead/archdesc//accruals[string-length(text()|*)!=0]">
            <p class="toc-lev1">
                <strong>
        ...
        <xsl:if test="ead/archdesc//bibliography[string-length(text()|*)!=0]">
            <p class="toc-lev1">
                <strong>
                    <xsl:choose>
                        <xsl:when test="ead/archdesc//bibliography/head[string-length(text()|*)!=0]">
                            <a href="#bibliography">
      ...
      <p class="toc-lev1">
        <strong>
          <xsl:choose>
            <xsl:when test="archdesc/dsc/head[string-length(text()|*)!=0]">
              <a href="#a23">
        ...
        <xsl:if test="ead/archdesc/dsc[string-length(text()|*)!=0]">
            <xsl:choose>
                <xsl:when
                    test="ead/archdesc/dsc/c01/child::c02 | ead/archdesc/dsc/c01/child::scopecontent | ead/archdesc/dsc/c01/child::descgrp">
                    <xsl:choose>
                            ...
                            <strong>
                                <a>
                                    ...
                                    <xsl:choose>
                                        ...
                                        <xsl:when test="did/unittitle/emph">
                                            <xsl:choose>
                                                <xsl:when test="did/unittitle/emph/unitdate">
                                                  <xsl:for-each select="did/unittitle/emph">
                                                  <xsl:value-of select="text()"/>
                                                  <xsl:text> </xsl:text>
                                                  <xsl:apply-templates select="./unitdate"/>
                                                  </xsl:for-each>
                                                ...
                                                <xsl:otherwise>
                                                  <xsl:apply-templates select="did/unittitle/emph"/>
                                                  <xsl:text> </xsl:text>
                                                  <xsl:apply-templates select="did/unitdate/emph"/>
                                                </xsl:otherwise>
                                            </xsl:choose>
                                        </xsl:when>
                                        <xsl:otherwise>
                    ...
                    <a href="#a23">
                        <p class="toc-lev1">
                            <strong>
                                <xsl:choose>
                                    <xsl:when
                                        test="ead/archdesc/dsc/head[string-length(text()|*)!=0]">
        ...
        <xsl:if test="ead/archdesc/index[string-length(text()|*)!=0]">
            <p class="toc-lev1">
                <strong>
                    <xsl:choose>
                        <xsl:when test="ead/archdesc/index/head[string-length(text()|*)!=0]">
                            <a href="#index">
    ...
    <xsl:template name="sponsor">
        <xsl:for-each select="ead/eadheader//sponsor">
            <table width="100%">
                <tr>
                    <td width="5%"/>
    ...
    <xsl:template match="name">
        <xsl:choose>
            <xsl:when test="parent::origination">
                <xsl:apply-templates/>
            </xsl:when>
            <xsl:otherwise>
                <br/>
    ...
    <xsl:template match="imprint">
        <xsl:for-each select="geogname | publisher | date | publicationstmt">
            <br/>
            <xsl:apply-templates/>
        </xsl:for-each>
    </xsl:template>
 ...
 inserting the contents if there is or adding one if there isn't. -->
    ...
    <xsl:template name="archdesc-bioghist">
		...
		<xsl:if
			test="ead/archdesc/bioghist[string-length(text()|*)!=0] | ead/archdesc/descgrp/bioghist[string-length(text()|*)!=0]">
			<xsl:for-each select="ead/archdesc/bioghist | ead/archdesc/descgrp/bioghist">
				<xsl:apply-templates/>
                <p>
	...
	<xsl:template match="ead/archdesc/bioghist/head | ead/archdesc/descgrp/bioghist/head">
        <h3>
	...
	<xsl:template match="ead/archdesc/bioghist/p | ead/archdesc/descgrp/bioghist/p">
        <p class="bod-in25">
            <xsl:apply-templates/>
        </p>
    </xsl:template>
	<xsl:template match="ead/archdesc/bioghist/note/p | ead/archdesc/descgrp/bioghist/note/p">
        <p class="bod-in25">
            <xsl:apply-templates/>
        </p>
    </xsl:template>
	<xsl:template match="ead/archdesc/bioghist/dao | ead/archdesc/descgrp/bioghist/dao">
        <div class="bod-in25">
            <xsl:call-template name="dao"/>
        </div>
    </xsl:template>
	<xsl:template match="ead/archdesc/bioghist/chronlist | ead/archdesc/descgrp/bioghist/chronlist">
		<xsl:apply-templates/>
    </xsl:template>
	<xsl:template match="ead/archdesc/bioghist/bioghist | ead/archdesc/descgrp/bioghist/bioghist">
        <h3 class="bod-in25">
            <xsl:apply-templates select="head"/>
        </h3>
        <xsl:for-each select="p">
    ...
    <xsl:template name="archdesc-scopecontent">
		<xsl:if
			test="ead/archdesc/scopecontent[string-length(text()|*)!=0] | ead/archdesc/descgrp/scopecontent[string-length(text()|*)!=0]">
			<xsl:for-each select="ead/archdesc/scopecontent | ead/archdesc/descgrp/scopecontent">
				<xsl:apply-templates/>
            </xsl:for-each>
            <p>
                <a href="#a0">Return to the Table of Contents</a>
	...
	<xsl:template match="ead/archdesc/scopecontent/head | ead/archdesc/descgrp/scopecontent/head">
        <h3>
            <a name="scopecontent">
                <xsl:apply-templates/>
            </a>
	...
	<xsl:template match="ead/archdesc/scopecontent/p | ead/archdesc/descgrp/scopecontent/p">
        <p class="bod-in25">
            <xsl:apply-templates/>
        </p>
    </xsl:template>
	<xsl:template
		match="ead/archdesc/scopecontent/note/p | ead/archdesc/descgrp/scopecontent/note/p">
        <p class="bod-in25">
            <xsl:apply-templates/>
        </p>
    </xsl:template>
	<xsl:template match="ead/archdesc/scopecontent/dao | ead/archdesc/descgrp/scopecontent/dao">
        <div class="bod-in25">
            <xsl:call-template name="dao"/>
        </div>
    </xsl:template>
	<xsl:template
		match="archdesc/scopecontent/scopecontent/head | archdesc/descgrp/scopecontent/scopecontent/head">
        <h3 class="bod-in25">
            <xsl:apply-templates/>
        </h3>
    </xsl:template>
	<xsl:template
		match="archdesc/scopecontent/scopecontent/p | ead/archdesc/descgrp/scopecontent/scopecontent/p">
        <p class="bod-in50">
            <xsl:apply-templates/>
        </p>
    </xsl:template>
	<xsl:template
		match="archdesc/scopecontent/scopecontent/dao | ead/archdesc/descgrp/scopecontent/scopecontent/dao">
        <div class="bod-in50">
            <xsl:call-template name="dao"/>
        </div>
    </xsl:template>
	...
	<xsl:template
		match="archdesc/scopecontent/arrangement/head | ead/archdesc/descgrp/scopecontent/arrangement/head">
        <h4 class="bod-in25">
            <strong>
                <xsl:apply-templates/>
            </strong>
	...
	<xsl:template
		match="archdesc/scopecontent/arrangement/p | ead/archdesc/descgrp/scopecontent/arrangement/p">
        <p class="bod-in25">
            <xsl:apply-templates/>
        </p>
    </xsl:template>
	<xsl:template
		match="archdesc/scopecontent/arrangement/list/head | ead/archdesc/descgrp/scopecontent/arrangement/list/head">
        <div class="bod-in25">
            <xsl:apply-templates/>
        </div>
    </xsl:template>
	<xsl:template
		match="archdesc/scopecontent/arrangement/list/item | ead/archdesc/descgrp/scopecontent/arrangement/list/item">
        <div class="bod-in50">
            <xsl:apply-templates/>
        </div>
    </xsl:template>
    ...
    <xsl:template name="archdesc-arrangement">
		...
		<xsl:if
			test="ead/archdesc/arrangement[string-length(text()|*)!=0] | ead/archdesc/descgrp/arrangement[string-length(text()|*)!=0]">
            <a name="arrangementlink"> &#xA0; </a>
			<xsl:for-each select="ead/archdesc/arrangement | ead/archdesc/descgrp/arrangement">
                <table width="100%">
                    <tr>
                        <td width="5%"/>
                        <td width="5%"/>
    ...
    <xsl:template name="archdesc-relatedmaterial">
        <xsl:if
			test="ead/archdesc/relatedmaterial[string-length(text()|*)!=0] | ead/archdesc/descgrp/descgrp/relatedmaterial[string-length(text()|*)!=0] | ead/archdesc/archdescgrp/relatedmaterial[string-length(text()|*)!=0]">
			<xsl:if test="ead/archdesc/descgrp/descgrp/relatedmaterial">
				<h3>
					<xsl:value-of select="ead/archdesc/descgrp/descgrp/head"/>
				</h3>
			</xsl:if>
			<xsl:for-each
				select="ead/archdesc/relatedmaterial | ead/archdesc/descgrp/descgrp/relatedmaterial | ead/archdesc/archdescgrp/relatedmaterial">
            <xsl:choose>
        ...
        <xsl:if
			test="ead/archdesc/separatedmaterial[string-length(text()|*)!=0] | ead/archdesc/descgrp/separatedmaterial[string-length(text()|*)!=0] | ead/archdesc/archdescgrp/separatedmaterial[string-length(text()|*)!=0]">
            <xsl:choose>
                <xsl:when test="child::head">
                    <h3>
                        <a name="sepmatlink">
            ...
            <xsl:for-each
                select="ead/archdesc/archdescgrp/separatedmaterial | ead/archdesc/separatedmaterial | ead/archdesc/descgrp/separatedmaterial">
                <table width="100%">
                    <tr>
                        <td width="5%"/>
                        <td width="5%"/>
    ...
    <xsl:template name="archdesc-otherfindaid">
        <xsl:if test="ead/archdesc//otherfindaid[string-length(text()|*)!=0]">
            <xsl:for-each
                select="ead/archdesc/archdescgrp/otherfindaid | ead/archdesc/otherfindaid | ead/archdesc/descgrp/otherfindaid">
                <xsl:choose>
                    <xsl:when test="child::head">
                        <h3>
                            <a name="otherfindaid">
    ...
    <xsl:template name="archdesc-index">
        <xsl:if test="ead/archdesc//index[string-length(text()|*)!=0]">
            <xsl:for-each
                select="ead/archdesc/archdescgrp/index | ead/archdesc/index | ead/archdesc/descgrp/index">
                    <h3>
					<a name="index">
                        <xsl:apply-templates select="head"/>
                	</a>
                ...
                <table width="100%">
                    ...
                    <xsl:for-each
                        ...
                        <tr>
                            ...
                            <td>
                                <xsl:choose>
                                    <xsl:when test="child::subarea | child::emph | child::extptr | child::lb | child::ptr">
                                        <xsl:apply-templates select="."/>
                                    </xsl:when>
                                    <xsl:otherwise>
										<xsl:value-of select="text()"/>
    ...
    <xsl:template name="archdesc-restrict">
        <xsl:if
            ...
            <xsl:for-each
                select="ead/archdesc/accessrestrict | ead/archdesc/archdescgrp/accessrestrict | ead/archdesc/descgrp/accessrestrict">
                <h4 class="bod-in15">
                    <strong>
                        <xsl:value-of select="head"/>
                    </strong>
            ...
            <xsl:for-each
                select="ead/archdesc/userestrict | ead/archdesc/archdescgrp/userestrict | ead/archdesc/descgrp/userestrict">
                <h4 class="bod-in15">
                    <strong>
                        <xsl:value-of select="head"/>
                    </strong>
            ...
            <xsl:for-each
                select="ead/archdesc/phystech | ead/archdesc/archdescgrp/phystech | ead/archdesc/descgrp/phystech">
                <h4 class="bod-in15">
                    <strong>
                        <xsl:value-of select="head"/>
                    </strong>
    ...
    <xsl:template name="archdesc-custodhist">
        <xsl:if
            ...
            <xsl:for-each
                select="ead/archdesc/archdescgrp/custodhist | ead/archdesc/custodhist |     ead/archdesc/descgrp/custodhist">
                <xsl:if test="child::head">
                    <h4 class="bod-in15">
    ...
    <xsl:template name="archdesc-altform">
        <xsl:if
            ...
            <xsl:for-each
                select="ead/archdesc/archdescgrp/altformavail | ead/archdesc/altformavail     | ead/archdesc/descgrp/altformavail">
                <xsl:if test="child::head">
                    <h4 class="bod-in15">
                        <a name="{generate-id(head)}">
                            <strong>
    ...
    <xsl:template name="archdesc-originalsloc">
        <xsl:if
            ...
            <xsl:for-each
                select="ead/archdesc/archdescgrp/originalsloc | ead/archdesc/originalsloc | ead/archdesc/descgrp/originalsloc">
                <xsl:if test="child::head">
                    <h4 class="bod-in15">
                        <a name="{generate-id(head)}">
                            <strong>
    ...
    <xsl:template name="archdesc-prefercite">
        <xsl:if
            ...
            <xsl:for-each
                select="ead/archdesc/archdescgrp/prefercite | ead/archdesc/prefercite | ead/archdesc/descgrp/prefercite">
                <xsl:if test="child::head">
                    <h4 class="bod-in15">
                        <a name="{generate-id(head)}">
                            <strong>
    ...
    <xsl:template name="archdesc-acqinfo">
        <xsl:if
            test="ead/archdesc/acqinfo[string-length(text()|*)!=0] | ead/archdesc/archdescgrp/acqinfo[string-length(text()|*)!=0] | ead/archdesc/descgrp/acqinfo[string-length(text()|*)!=0]">
            <xsl:for-each
                select="ead/archdesc/archdescgrp/acqinfo | ead/archdesc/acqinfo | ead/archdesc/descgrp/acqinfo">
                <xsl:if test="child::head">
                    <h4 class="bod-in15">
                        <a name="{generate-id(head)}">
                            <strong>
    ...
    <xsl:template name="archdesc-processinfo">
        <xsl:if
            ...
            <xsl:for-each
                select="ead/archdesc/archdescgrp/processinfo | ead/archdesc/processinfo | ead/archdesc/descgrp/processinfo">
                <xsl:if test="child::head">
                    <h4 class="bod-in15">
                        <a name="{generate-id(head)}">
                            <strong>
    ...
    <xsl:template name="archdesc-appraisal">
        <xsl:if
            ...
            <xsl:for-each
                select="ead/archdesc/archdescgrp/appraisal | ead/archdesc/appraisal | ead/archdesc/descgrp/appraisal">
                <xsl:if test="child::head">
                    <h4 class="bod-in15">
                        <a name="{generate-id(head)}">
                            <strong>
    ...
    <xsl:template name="archdesc-accruals">
        <xsl:if
            test="ead/archdesc/accruals[string-length(text()|*)!=0] | ead/archdesc/archdescgrp/accruals[string-length(text()|*)!=0] | ead/archdesc/descgrp/accruals[string-length(text()|*)!=0]">
            <xsl:for-each
                select="ead/archdesc/archdescgrp/accruals | ead/archdesc/accruals | ead/archdesc/descgrp/accruals">
                <xsl:if test="child::head">
                    <h4 class="bod-in15">
                        <a name="{generate-id(head)}">
                            <strong>
        ...
        <xsl:for-each select="c01">
            <table width="100%">
				...
				<xsl:for-each select="descgrp">
					...
					<xsl:for-each
						select="phystech | scopecontent | bioghist | arrangement | acqinfo">
						<xsl:for-each select="head">
							<tr>
								<td/>
								<td colspan="13" valign="top">
				...
				<xsl:for-each select="dao | descgrp/dao">
                    <tr>
                        <td/>
                        <td colspan="13" valign="top">
                            <xsl:call-template name="dao"/>
                ...
                <xsl:for-each
                    select="note | accessrestrict | userestrict | phystech | prefercite | acqinfo | originalsloc | processinfo | odd">
                    <xsl:for-each select="head">
                        <tr>
                            <td/>
                            <td colspan="13" valign="top">
                ...
                <xsl:for-each select="c02">
                    <xsl:for-each select="did">
                        ...
                        <xsl:choose>
                            <xsl:when
                                test="preceding::did[1][container[@type][1]=$cntr-number] and preceding::did[1][container[1]/@type=$cntr-type] or not(./container)">
